...
// static void ad_get_stream_data_replace_stream_back(AdGetClassification *sample_filter, Mat &mask);
// static void ad_get_stream_data_initialize_images(AdGetClassification *sample_filter, GstVideoFrame *frame, GstMapInfo &info);
